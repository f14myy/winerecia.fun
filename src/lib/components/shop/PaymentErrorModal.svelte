<script>
	import { AlertCircle, RotateCw, X } from 'lucide-svelte';
	...
	>
		...
		>
			...
			<div class="modal__content">
				...
				<h2 class="modal__title">Ошибка оплаты</h2>
				<p class="modal__text">
					К сожалению, произошла ошибка при обработке платежа. Пожалуйста, попробуйте еще раз или
